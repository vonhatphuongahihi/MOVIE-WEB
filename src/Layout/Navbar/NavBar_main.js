...
function Navbar() {
  ...
  return (
    <div>
      {/* Main NavBar */}
      <div className="bg-main shadow-md fixed top-0 left-0 right-0 z-20 border-b border-gray-300 border-opacity-30 text-nowrap text-center text-sm xl:text-base text-subMain">
        <div className="container mx-auto py-2 px-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 text-subMain">
            <Link to="/" className="mr-2">
              <img src="/images/logo.png" alt="logo" className="w-18 h-5 object-contain" />
            </Link>
