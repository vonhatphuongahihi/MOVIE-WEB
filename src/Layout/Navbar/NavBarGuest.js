  ...
  return (
    <div>
      ...
      <div  className={`${
        ...
        <div className="container mx-auto py-1 px-2 flex gap-4 justify-center items-center text-center text-wrap text-xs sm:text-sm lg:text-base hidden lg:block">
